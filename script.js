...
// Define the expression and the result keyword

let expression = '';
let result = '';

// Define the Event Handeler for button clicks
...
function addvalue(value){
    if(value === '.'){
        // Find the index of the last operaton in the expression
        ...
        // Check if this is the first decimal in the expression or if the exression is empty
        if(
...
function percentage(){
    ...
    if(expression !== ''){
        ...
        // If expression is empty but the result exists, devide by 100.
